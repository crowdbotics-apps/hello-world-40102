"""
Django settings for hello_world_40102 project.
...
ROOT_URLCONF = 'hello_world_40102.urls'
...
WSGI_APPLICATION = 'hello_world_40102.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hello_world_40102 API",
    "DESCRIPTION": "API documentation for hello_world_40102 App",
    "VERSION": "v1",
}
